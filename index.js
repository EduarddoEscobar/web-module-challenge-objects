...
*/
const bec = createMenuItem('Bacon Egg And Cheese', '5', 'Breakfast');
console.log(bec);
const fruitPunch = createMenuItem('Fruit Punch', '2', 'Drinks');
console.log(fruitPunch);
const cheeseCake = createMenuItem('Cheesecake', '6', 'Desserts');
